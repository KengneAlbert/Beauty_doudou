...
const Hero: React.FC<HeroProps> = ({ onBookingClick }) => {
  return (
    <section id="home" className="relative bg-gradient-to-br from-pink-50 to-rose-100 py-20">
        ...
        <div className="flex items-center justify-between">
          <div className="max-w-2xl">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-gray-600 text-sm">Complexe de beauté de référence</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Découvrez l'excellence en matière de beauté et de bien-être. Nos experts vous offrent 
              des services personnalisés dans nos centres de Yaoundé et Douala.
            </p>
          ...
          <div className="hidden lg:block">
            <div className="w-96 h-96 rounded-full bg-gradient-to-br from-pink-200 to-rose-300 flex items-center justify-center">
              <div className="w-80 h-80 rounded-full bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center shadow-2xl">
                {/* <div className="text-white text-8xl font-bold">BD</div> */}
                <img src={Logo} alt="Logo Beauty by Doudou" className="w-64 h-64 rounded-full object-cover" />
              </div>
            </div>
          </div>
        </div>
